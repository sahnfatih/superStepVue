              ...
              <ul class="menu-list">
                ...
                <div class="user-icon" @click="togglePopup">
                    <img
                      loading="lazy"
                      class="icon-favorite-svg"
                      src="https://688268d7.cdn.akinoncloud.com/static_omnishop/super734/assets/img/header-icons/user.svg"
                      height="24px"
                      alt="User"
                    />
                    ...
                    <div v-if="popupVisible" class="popup-content" @click.stop>
                      <p>{{ userEmail }}</p>
                      <ul>
                        <li><router-link to="/">Hesabım</router-link></li>
                        <li><router-link to="/">Siparişlerim</router-link></li>
                        <li><router-link to="/">Kullanıcı Bilgilerim</router-link></li>
                        <li><router-link to="/">İndirim Kuponlarım</router-link></li>
                        <li><router-link to="/">Adres Bilgilerim</router-link></li>
                        <li><router-link to="/">Yardım</router-link></li>
                        <li @click="signOut">Çıkış Yap</li>
                      </ul>
                    </div>
                  </div>
